...
const CARD_BG =
  "bg-[linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0)),url('https://baos70mga7.ufs.sh/f/FIOeDmU4bLHB8p9P9c0aFPAROd8kp7WeY6GqCNyfLrEUzvxX')] bg-cover bg-center";
    ...
    <div className="fixed inset-0 bg-[#111] w-full flex flex-col items-center justify-center antialiased overflow-hidden select-none overscroll-none font-['DM_Sans',sans-serif]">
      ...
      <div className="relative w-70 h-105">
        ...
        <motion.div
          ...
          className="absolute inset-0 rounded-4xl border border-white/8 z-0 overflow-hidden"
        >
          <div className={`absolute inset-0 ${CARD_BG} scale-110`} />
        </motion.div>
        ...
        <div className="absolute inset-0 perspective-distant z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute inset-0 backface-hidden rounded-4xl border border-white/8 overflow-hidden flex flex-col"
            >
              {/* Background layer */}
              <div className={`absolute inset-0 ${CARD_BG} scale-110`} />
            ...
            {/* ══ BACK FACE ══ */}
            <div className="absolute inset-0 backface-hidden transform-[rotateY(180deg)] rounded-4xl border border-white/12 overflow-hidden flex flex-col items-center justify-center gap-[1.4rem]">
              {/* Background layer */}
              <div className={`absolute inset-0 ${CARD_BG} scale-110`} />
