    ...
    <UiShowcaseLayout
      ...
      description={
        <p>
          ...
          minimalist selector for primary settings and a dense context menu for
          deep actions.
        </p>
      }
    >
      ...
      >
        <p>
          ...
          section headers to organize high-density information. Both components
          use{" "}
