...
const ROW_0: KeyInfo[] = Array(14)
  .fill(0)
  .map((_, i) => ({
    key: i === 0 ? "Esc" : i === 13 ? "Del" : `F${i}`,
    flex: 1,
  }));
const ROW_1: KeyInfo[] = [
  { key: "`", flex: 1 },
  ...
  { key: "-", flex: 1 },
  { key: "=", flex: 1 },
  { key: "Backspace", flex: 2, display: "⌫" },
];
const ROW_2: KeyInfo[] = [
  { key: "Tab", flex: 1.5, display: "⇥" },
  { key: "Q", flex: 1 },
  { key: "W", flex: 1 },
  { key: "E", flex: 1 },
  { key: "R", flex: 1 },
...
const ROW_3: KeyInfo[] = [
  ...
  { key: ";", flex: 1 },
  { key: "'", flex: 1 },
  { key: "Enter", flex: 2.25, display: "↩" },
];
const ROW_4: KeyInfo[] = [
  { key: "Shift", flex: 2.25, display: "⇧" },
  { key: "Z", flex: 1 },
  { key: "X", flex: 1 },
  { key: "C", flex: 1 },
  { key: "V", flex: 1 },
  ...
  { key: ".", flex: 1 },
  { key: "/", flex: 1 },
  { key: "Shift", flex: 2.75, display: "⇧" },
];
const ROW_5: KeyInfo[] = [
  { key: "fn", flex: 1 },
  { key: "ctrl", flex: 1, display: "⌃" },
  { key: "opt", flex: 1, display: "⌥" },
  { key: "cmd", flex: 1.25, display: "⌘" },
  { key: "Space", flex: 6.25, display: "" },
  { key: "cmd", flex: 1.25, display: "⌘" },
  { key: "opt", flex: 1, display: "⌥" },
  { key: "←", flex: 0.75 },
  { key: "↑", flex: 0.75 },
...
export const Keyboard: React.FC<KeyboardProps> = ({ shortcuts, activeKey }) => {
  const shortcutKeys = new Set(
    shortcuts.flatMap((s) => s.keys).map((k) => k.toUpperCase()),
  );
  ...
  return (
    <div className="bg-[#050505] p-4 md:p-8 rounded-2xl shadow-2xl border border-white/10 w-full aspect-[16/7.8] flex flex-col justify-between mb-8 select-none">
              ...
              return (
                <motion.div
                  ...
                  className={`
                    ...
                    ${
                      isActive
                        ? "bg-[#222] border-white/40 translate-y-px scale-[0.98] shadow-inner text-white"
      ...
      <div className="mx-auto w-[42%] h-[18%] rounded-xl bg-linear-to-b from-white/10 to-transparent border-t border-white/5 mt-4" />
    </div>
  );
};
