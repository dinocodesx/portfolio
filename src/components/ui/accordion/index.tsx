...
const ACCORDION_ITEMS = [
  {
    ...
    content:
      "Our system is built on a distributed microservices model, utilizing gRPC for high-performance inter-service communication and Kafka for reliable event streaming across regional clusters.",
  },
  {
    id: "02",
    title: "Data Consistency",
    content:
      "We implement strong eventual consistency using a combination of Raft-based consensus for critical metadata and CRDTs for collaborative real-time editing features.",
  },
  {
    id: "03",
    title: "Observability Stack",
    content:
      "Full-stack visibility is achieved through OpenTelemetry instrumented traces, Prometheus metrics for real-time alerting, and Grafana dashboards for deep-dive analysis.",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-12">
          ...
          <div className="space-y-12">
            ...
            >
              <p>
                A study on{" "}
                <span className="text-white">spatial continuity</span>. This
                accordion utilizes Framer Motion's automatic layout animations
            ...
            >
              <p>
                The transition uses a{" "}
                <code className="bg-white/10 px-1.5 py-0.5 rounded text-[13px] text-white/80">
                  custom cubic-bezier
                </code>{" "}
                curve to mimic physical weight. The numbering and icons shift
                color to provide clear{" "}
