    ...
    <UiShowcaseLayout
      ...
      description={
        <p>
          ...
          the triggers below to see how different system states are
          communicated.
        </p>
      }
    >
      ...
      >
        <p>
          ...
          wrapper to handle state changes smoothly. This pattern is ideal for{" "}
          <span className="text-white">inline feedback</span> where the
          component needs to occupy space while providing critical system
          updates.
        </p>
      </motion.div>
    </UiShowcaseLayout>
