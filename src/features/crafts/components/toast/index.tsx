...
export function Toast() {
  ...
  const getMessage = (type: ToastType) => {
    switch (type) {
      case "success": return "System state synchronized successfully.";
      case "error": return "Failed to establish secure connection.";
      case "info": return "New firmware update available for download.";
      case "system": return "Kernel initialized. Welcome back.";
      default: return "";
    }
  };
